...
def task(work, id):
    ...
    work['result'] = pa.table([pvnames, timestamps, integers, floats, strings, binaries], schema=orc_schema)
...
writer = orc.ORCWriter('demo3.orc', dictionary_key_size_threshold=1)
